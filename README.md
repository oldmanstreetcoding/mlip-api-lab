...
```bash
$ git clone https://github.com/eshetty/mlip-api-lab
$ cd mlip-api-lab
```
...
Install the dependencies in the `requirements.txt` file with pip or similar:
```bash
$ pip install -r requirements.txt
```

Replace Endpoint and Key with your own in [analyze.py](https://github.com/eshetty/mlip-api-lab/blob/main/analyze.py). 
To set up the flask server, just run `python3 app.py`. The system should try to analyze an example image and report the results when you go to http://localhost:3000/
...
```
- Ensure this file is kept secure and is not committed to version control by adding it to `.gitignore`.
